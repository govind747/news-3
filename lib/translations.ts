...
export const t: Record<string, Record<Lang, string>> = {
  ...
  login_subtitle: { en: 'Sign in to your VedaWell account', hi: 'अपने वेदावेल खाते में साइन इन करें' },
  ...
  // Signup
  join_vedawell: { en: 'Join VedaWell', hi: 'वेदावेल से जुड़ें' },
  ...
  newsletter_title: { en: 'The VedaWell Newsletter', hi: 'वेदावेल न्यूज़लेटर' },
