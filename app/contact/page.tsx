  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <AdBanner slot="contact-top" size="leaderboard" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-5">
              {[
                { Icon: Mail, title: 'Email', lines: ['hello@vedawell.in', 'editorial@vedawell.in'] },
            ...
            <div className="mt-8 p-5 bg-[#F8F8F8] border border-[#E8E8E8]">
              ...
              <p className="text-xs text-[#666] font-body leading-relaxed mb-2">
                Interested in sponsored content, product reviews, affiliate partnerships, or advertising on VedaWell?
              </p>
              <a href="mailto:partners@vedawell.in" className="text-xs font-semibold text-brand hover:underline font-body">
                partners@vedawell.in →
              </a>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 pb-8">
        <AdBanner slot="contact-bottom" size="leaderboard" />
      </div>
    </>
  );
}
