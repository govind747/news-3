        ...
        <div className="prose prose-sm max-w-none font-body text-[#444] space-y-6">
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'VedaWell वेबसाइट और सेवाओं का उपयोग करके, आप इन उपयोग की शर्तों से बाध्य होने के लिए सहमत होते हैं। यदि आप इन शर्तों से सहमत नहीं हैं, तो कृपया हमारी सेवाओं का उपयोग न करें।'
                : 'By using the VedaWell website and services, you agree to be bound by these terms of use. If you do not agree with these terms, please do not use our services.'}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'VedaWell पर सभी सामग्री, लोगो, और ब्रांडिंग हमारी बौद्धिक संपदा है। बिना हमारी लिखित अनुमति के इसका उपयोग या पुनरुत्पादन प्रतिबंधित है।'
                : 'All content, logos, and branding on VedaWell is our intellectual property. Use or reproduction without our written permission is prohibited.'}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'VedaWell किसी भी परोक्ष, आकस्मिक, या परिणामी क्षति के लिए उत्तरदायी नहीं होगा। हमारी कुल दायित्व आपके द्वारा भुगतान की गई राशि तक सीमित है।'
                : 'VedaWell shall not be liable for any indirect, incidental, or consequential damages. Our total liability is limited to the amount paid by you.'}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'इन शर्तों के बारे में किसी भी प्रश्न के लिए, कृपया हमसे संपर्क करें: legal@vedawell.in'
                : 'For any questions regarding these terms, please contact us: legal@vedawell.in'}
            </p>
          </section>
        </div>
      </div>
