...
import { CheckCircle, Users, BookOpen, Heart, TrendingUp, Award } from 'lucide-react';
import AdBanner from '@/components/ads/AdBanner';

export const metadata = {
  title: 'About Us – VedaWell',
  description: 'Learn about VedaWell — India\'s trusted wellness platform combining ancient Ayurvedic wisdom with modern health science.',
};
...
const values = [
  ...
  { Icon: Users, title: 'Community First', desc: 'VedaWell exists to serve our readers. We listen, we respond, and we continuously improve based on your needs and feedback.' },
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <AdBanner slot="about-top" size="leaderboard" />
      </div>
      ...
      <section className="bg-[#F8F8F8] border-y border-[#E8E8E8] py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-[#888] font-body">The values that guide every article, product, and decision at VedaWell</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-[#888] font-body">Meet the specialists behind VedaWell's trusted content</p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 pb-8">
        <AdBanner slot="about-bottom" size="leaderboard" />
      </div>
    </>
  );
}
