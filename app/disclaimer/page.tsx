        ...
        <div className="prose prose-sm max-w-none font-body text-[#444] space-y-6">
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'VedaWell पर प्रदान की गई जानकारी केवल सूचनात्मक उद्देश्यों के लिए है और यह पेशेवर चिकित्सा सलाक्ष, निदान, या उपचार का विकल्प नहीं है। किसी भी चिकित्सीय स्थिति के लिए हमेशा अपने चिकित्सक या अन्य योग्य स्वास्थ्य सेवा प्रदाता की सलाह लें।'
                : 'The information provided on VedaWell is for informational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider for any medical condition.'}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'VedaWell किसी भी प्रकार की वारंटी, व्यक्त या निहित, के साथ सेवाएं और सामग्री प्रदान करता है। हम सटीकता, पूर्णता, या विश्वसनीयता की गारंटी नहीं देते।'
                : 'VedaWell provides services and content "as is" without any warranties, express or implied. We do not guarantee accuracy, completeness, or reliability.'}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'इस अस्वीकरण के बारे में किसी भी प्रश्न के लिए, कृपया हमसे संपर्क करें: support@vedawell.in'
                : 'For any questions regarding this disclaimer, please contact us: support@vedawell.in'}
            </p>
          </section>
        </div>
      </div>
