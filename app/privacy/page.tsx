      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-sm max-w-none font-body text-[#444] space-y-6">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'आपको अपनी व्यक्तिगत डेटा तक पहुंचने, इसे सुधारने या हटाने का अधिकार है। किसी भी संबंधित अनुरोध के लिए हमसे support@vedawell.in पर संपर्क करें।'
                : 'You have the right to access, correct, or delete your personal data. Contact us at support@vedawell.in for any related requests.'}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              {lang === 'hi'
                ? 'इस गोपनीयता नीति के बारे में किसी भी प्रश्न के लिए, कृपया हमसे संपर्क करें: support@vedawell.in'
                : 'For any questions about this privacy policy, please contact us: support@vedawell.in'}
            </p>
          </section>
        </div>
      </div>
