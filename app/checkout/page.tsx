...
export default function CheckoutPage() {
  ...
  const downloadBill = () => {
    ...
    a.href = url;
    a.download = `VedaWell_Invoice_${completedOrder.order_number}.html`;
    a.click();
...
<html>
<head>
  <title>VedaWell Invoice - ${order.order_number}</title>
  <style>
...
<body>
  ...
  <div class="footer">
    <p>Thank you for shopping with VedaWell!</p>
    <p>For any queries, contact us at support@vedawell.in</p>
    <p>© ${new Date().getFullYear()} VedaWell. All rights reserved.</p>
  </div>
</body>
</html>
    `;
