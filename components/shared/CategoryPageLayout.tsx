...
import { ChevronLeft, ChevronRight, TrendingUp, Clock, Flame, Loader2 } from 'lucide-react';
          ...
          <div className="flex-1 min-w-0">
            {loading ? (
              ...
              <>
                ...
                {/* Mid banner ad */}
                <AdBanner slot="banner-2" category={categorySlug} subcategory={selectedSubcategory || undefined} className="mb-8" />
                ...
                {/* Bottom banner ad */}
                <AdBanner slot="banner-3" category={categorySlug} className="mb-8" />
