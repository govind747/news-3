...
import { X, Eye, EyeOff, Mail, Lock, User, Phone, AtSign, AlertCircle, CheckCircle, Loader2 } from 'lucide-react';
...
const AUTH_IMAGE = 'https://images.pexels.com/photos/3823488/pexels-photo-3823488.jpeg?auto=compress&cs=tinysrgb&w=700';
...
function LoginForm({ onTabChange }: { onTabChange: (t: Tab) => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    setMsg(null);
    const email = identifier.includes('@') ? identifier : `${identifier}@vedawell.in`;
...
export default function AuthModal() {
  ...
  const tabConfig = {
    ...
    signup: { title: t('join_vedawell'), subtitle: t('signup_subtitle') },
