    ...
    <div className="group relative">
      <div className="relative overflow-hidden bg-[#F8F8F8] mb-3 product-img-wrap">
        ...
        <button
          ...
          className={`absolute bottom-0 left-0 right-0 py-2.5 text-center text-[11px] font-bold uppercase tracking-widest text-white translate-y-full group-hover:translate-y-0 transition-transform duration-300 cursor-pointer flex items-center justify-center gap-2 ${
            added ? 'bg-green-600' : 'bg-[#111] hover:bg-brand'
          }`}
        >
          {added ? (
            <>
